...
| [Django (Security)](frameworks/django-security/SKILL.md) | CSRF, authentication, custom permission backends, per-object permissions, sessions, password handling, middleware, Django 6.0 compatibility | 1,682 | python, django, web-framework, async, hub |
