...
| [Django](frameworks/django/SKILL.md) | Security, ORM, PostgreSQL, GeoDjango, Django 6.0 essentials, admin extensions, middleware, authentication, sessions, ecosystem tools, multi-DB routing, model conventions | 2,512 | python, django, web-framework, async, hub |
|   ↳ [django-admin](frameworks/django-admin/SKILL.md) | Django Admin - save_formset, get_search_results, get_formset, queryset optimization, db_index, custom URLs, action payload, ecosystem (admin-action-forms, hijack, simple-history) | 582 | python, django, admin, orm, optimization |
...
| [Django Bolt](frameworks/django-bolt/SKILL.md) | Rust-powered API framework v0.11.0 - 300k+ RPS, runbolt server, JWT+JWKS, MCP servers, loading plans, SSE/WebSocket, worker recycling | 2,301 | python, django, bolt, api, rust, performance, async |
| [Django Celery](frameworks/django-celery/SKILL.md) | Django Celery integration - distributed tasks, django-celery-beat scheduling, cron-vs-beat, batch processing, monitoring, flower, ecosystem | 713 | python, django, celery, task-queue, periodic-tasks, django-celery-beat |
...
| [Django TDD](frameworks/django-tdd/SKILL.md) | Django TDD with pytest-django - factory_boy, model-bakery, mocking, coverage, test-migrations, test-plus, testing pitfalls | 844 | python, django, testing, pytest, tdd |
| [Django Unfold](frameworks/django-unfold/SKILL.md) | Modern Django admin theme - @display decorator, charts, CSP nonce, customization, actions, filters, Django 6.x compat, INSTALLED_APPS ordering | 802 | python, django, admin, unfold, theme, dashboard |
| [django-allauth](frameworks/django-allauth/SKILL.md) | django-allauth 65.x - local accounts, OAuth, email verification, MFA, OIDC provider (allauth.idp.oidc), django-organizations, Django 6.0 compatible | 607 | python, django, authentication, oauth, mfa, allauth, oidc |
