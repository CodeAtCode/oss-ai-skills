...
| [Django](frameworks/django/SKILL.md) | Security, ORM, PostgreSQL, GeoDjango, Django 6.0 essentials, admin extensions, middleware, authentication, sessions, ecosystem tools | 2,371 | python, django, web-framework, async, hub |
|   ↳ [django-admin](frameworks/django-admin/SKILL.md) | Django Admin - save_formset, get_search_results, get_formset, queryset optimization, db_index, ecosystem (admin-action-forms, hijack, simple-history) | 556 | python, django, admin, orm, optimization |
...
| [Django Celery](frameworks/django-celery/SKILL.md) | Django Celery integration - distributed tasks, django-celery-beat scheduling, monitoring, flower, ecosystem | 644 | python, django, celery, task-queue, periodic-tasks, django-celery-beat |
...
| [Django TDD](frameworks/django-tdd/SKILL.md) | Django TDD with pytest-django - factory_boy, model-bakery, mocking, coverage, test-migrations, test-plus | 808 | python, django, testing, pytest, tdd |
